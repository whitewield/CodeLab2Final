	...
	namespace PoppingParticlePool {
		...
		public static class ParticleActions {
			...
			public static void SetColor (ParticleSystem g_particleSystem, Color g_color) {
				...
				ParticleSystem.TrailModule t_trail = g_particleSystem.trails;
				ParticleSystem.MinMaxGradient t_trailGradient = new ParticleSystem.MinMaxGradient (g_color);
				t_trail.colorOverTrail = t_trailGradient;
			}
		}
	}
}
